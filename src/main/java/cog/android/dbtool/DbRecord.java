...
/**
 * Represents/mimics a database table row. It's basically wrapper over the
 * ContentValues class, to allow for chained method calls, and other
 * functionality. You can retrieve the corresponding ContentValues object for
 * use, by calling toContentValues() on the instance.
 * 
