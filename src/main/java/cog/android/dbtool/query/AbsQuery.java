...
public abstract class AbsQuery implements IQuery {
	...
	public AbsQuery(SQLiteDatabase db) {
		_sqliteDb = db;
		_table = "";
	...
	/**
	 * Indicates the columns to perform a SELECT query on. Returns a
	 * org.ikmich.android.db.RecordSet, as opposed to the select() method which
	 * returns a Cursor
	 */
	...
	/**
	 * Indicates for a SELECT query to use the DISTINCT keyword to return unique
	 * rows.
	 */
