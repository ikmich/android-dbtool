...
public interface IQuery {
	...
	/**
	 * Indicates intent of a "SELECT ALL" query designed to return values and
	 * not a Cursor.
	 * 
	 * @return
	 */
	...
	/**
	 * Defines columns to be queried in a "SELECT" query designed to return
	 * values.
	 * 
	 * @param columns
	 * @return
	...
	/**
	 * Defines columns to be queried in a "SELECT" query designed to return a
	 * Cursor.
	 * 
	 * @param columns
	 * @return
	...
	/**
	 * Defines columns o be queried in a "SELECT" query designed to return a
	 * Cursor.
	 * 
	 * @param columns
	 * @return
